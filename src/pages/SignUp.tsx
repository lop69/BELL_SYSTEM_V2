  ...
  const onSubmit = async (data: SignUpFormInputs) => {
    ...
    try {
      ...
      if (error) {
        ...
        navigate("/login", { state: { role, department } });
      }
    } catch (error: any) {
      showError(error.message || "An unexpected error occurred during sign up.");
    } finally {
      ...
      <div className="w-full max-w-sm">
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-1">Create your {role} account in {department}</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <Button
              ...
              onClick={() => navigate("/login", { state: { role, department } })}
            >
